...
insert into stages (idStage, etape, dateVisite, nomVisiteur, lieuRealisation, deplacement, frequenceDeplacement, modeDeplacement, attFormReglement, libelleAttFormReg, visiteMedical, travauxDang, dateDeclarationDerog, sujetStage, travauxRealises, objectifPAE, dateDebut, dateFin, idTuteur, idStagiaire, idPeriode) values (3, 2, '2020-06-02 11:16:47', 'Lenard Mengue', 'Entreprise', 0, 'Quotidien', 'Vehicule de l entreprise', 1, 'attestation formation reglementaire', 0, 1, '2020-07-13 23:45:38', 'Assimilated upward-trending contingency', 'Exclusive fresh-thinking throughput', 'Multi-channelled explicit website', '2020-07-02 18:30:19', '2020-11-25 18:52:22',3, 2,2);
