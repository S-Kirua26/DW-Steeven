...
class UtilisateursManager 
{
	...
	{
 		$db=DbConnect::getDb();
		$q=$db->prepare("INSERT INTO utilisateurs (nomUtilisateur,prenomUtilisateur,ageUtilisateur,idRole) VALUES (:nomUtilisateur;:prenomUtilisatuer,:ageUtilisateur,:idRole)");
