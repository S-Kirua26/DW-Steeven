 ...
 Class Utilisateurs {
	...
	*/
	public function toString(){
		return " idUtilisateur : ".$this->getIdUtilisateur()	." nomUtilisateur : ".$this->getNomUtilisateur()	." prenomUtilisateur : ".$this->getPrenomUtilisateur()	." motDePasseUtilisateur : ".$this->getMotDePasseUtilisateur()	." adresseMailUtilisateur : ".$this->getAdresseMailUtilisateur()	." roleUtilisateur : ".$this->getRoleUtilisateur()	." pseudoUtilisateur : ".$this->getPseudoUtilisateur()	;
	}
