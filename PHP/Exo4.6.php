...
while (ctype_alpha($Candidat1) or ctype_alpha($Candidat2) or ctype_alpha($Candidat3) or ctype_alpha($Candidat4) or (($Candidat1 <= 0) or ($Candidat2 <= 0) or ($Candidat3 <= 0) or ($Candidat4 <= 0)))
    ...
    //Autre façon de faire moins dynamique
/*do {
    $Candidat1 = readline("Veuillez ecrire le score du candidat 1 (total sur 100)\n");
    $Candidat2 = readline("Veuillez ecrire le score du candidat 2 (total sur 100)\n");
    $Candidat3 = readline("Veuillez ecrire le score du candidat 3 (total sur 100)\n");
...
switch ($Candidat1) {
    ...
    case ($Candidat2 > $Total / 2 or $Candidat3 > $Total / 2 or $Candidat4 > $Total / 2):
        echo "Vous avez perdu, dommage";
        break;

    case ($Candidat1 > $Candidat2 and $Candidat1 > $Candidat3 and $Candidat1 > $Candidat4 and $Candidat1 < $Total / 2):
        echo "Vous êtes en ballotage favorable";
        break;

    case (($Candidat2 > $Candidat1 or $Candidat3 > $Candidat1 or $Candidat4 > $Candidat1) and ($Candidat2 < $Total / 2 and $Candidat3 < $Total / 2 and $Candidat4 < $Total / 2) and $Candidat1 > ($Total * (12.5 / 100))):
        echo "Vous êtes en ballotage défavorable";
        break;

    case (($Candidat1 == $Candidat2 or $Candidat1 == $Candidat3 or $Candidat1 == $Candidat4) or ($Candidat1 == $Candidat2 and $Candidat1 == $Candidat3 and $Candidat1 == $Candidat4) and ($Candidat1 < $Total / 2 and $Candidat2 < $Total / 2 and $Candidat3 < $Total / 2 and $Candidat4 < $Total / 2)):
